...
var Contract = /** @class */ (function () {
    ...
    // Deploy the contract with the bytecode, repolving to the deployed address.
...
function getDefaultProvider(network) {
    return new fallback_provider_1.FallbackProvider([
        ...
        new sophyscan_provider_1.SophyscanProvider(network),
    ]);
}
exports.getDefaultProvider = getDefaultProvider;

},{"./sophyscan-provider":53,"./fallback-provider":54,"./infura-provider":56,"./ipc-provider":42,"./json-rpc-provider":57,"./provider":58,"./susyweb-provider":59}],56:[function(require,module,exports){
'use strict';
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
Object.defineProperty(exports, "__esModule", { value: true });
// See: https://octonion.institute/susy-go/wiki/JSON-RPC
var provider_1 = require("./provider");
var address_1 = require("../utils/address");
var bytes_1 = require("../utils/bytes");
var networks_1 = require("../utils/networks");
...
var JsonRpcSigner = /** @class */ (function (_super) {
    ...
    JsonRpcSigner.prototype.sendTransaction = function (transaction) {
        ...
        return properties_1.resolveProperties(tx).then(function (tx) {
            ...
            return _this.provider.send('sof_sendTransaction', [tx]).then(function (hash) {
                return web_1.poll(function () {
    ...
    JsonRpcSigner.prototype.signMessage = function (message) {
        ...
        return this.getAddress().then(function (address) {
            // https://octonion.institute/susy-go/wiki/JSON-RPC#sof_sign
...
var JsonRpcProvider = /** @class */ (function (_super) {
    ...
    JsonRpcProvider.prototype.perform = function (method, params) {
        switch (method) {
            ...
            case 'sendTransaction':
                return this.send('sof_sendRawTransaction', [params.signedTransaction]);
            case 'getBlock':
                if (params.blockTag) {
                    return this.send('sof_getBlockByNumber', [params.blockTag, false]);
                }
                else if (params.blockHash) {
                    return this.send('sof_getBlockByHash', [params.blockHash, false]);
                }
            ...
            case 'call':
                return this.send('sof_call', [JsonRpcProvider.hexlifyTransaction(params.transaction), 'latest']);
            case 'estimateGas':
                return this.send('sof_estimateGas', [JsonRpcProvider.hexlifyTransaction(params.transaction)]);
            case 'getLogs':
...
var Provider = /** @class */ (function (_super) {
    ...
    Provider.prototype.getSophyPrice = function () {
        var _this = this;
        return this.ready.then(function () {
...
},{"../utils/address":61,"../utils/bignumber":62,"../utils/bytes":63,"../utils/errors":64,"../utils/hash":65,"../utils/networks":69,"../utils/properties":70,"../utils/srlp":71,"../utils/transaction":75,"../utils/types":76,"../utils/utf8":78,"../utils/web":79}],59:[function(require,module,exports){
'use strict';
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var SusyWebProvider = /** @class */ (function (_super) {
    ...
    SusyWebProvider.prototype.send = function (method, params) {
        var _this = this;
        // Susylink complains about sof_sign (and on some versions hangs)
        if (method == 'sof_sign' && this._susywebProvider.isSusyLink) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this._susywebProvider.sendAsync(request, function (error, result) {
                if (error) {
                    reject(error);
                    return;
                }
...
},{"./bytes":63,"./errors":64,"./keccak256":68,"./srlp":71,"bn.js":2}],62:[function(require,module,exports){
'use strict';
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
exports.ConstantWeiPerSophy = bigNumberify('1000000000000000000');
...
var constants = {
    ...
    WeiPerSophy: bignumber_1.ConstantWeiPerSophy
};
exports.constants = constants;

},{"./abi-coder":60,"./address":61,"./base64":41,"./bignumber":62,"./bytes":63,"./errors":64,"./hash":65,"./json-wallet":67,"./keccak256":68,"./networks":69,"./properties":70,"./random-bytes":45,"./srlp":71,"./secp256k1":72,"./sha2":73,"./polynomial":74,"./transaction":75,"./types":76,"./units":77,"./utf8":78,"./web":79}],67:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var address_1 = require("./address");
...
"use strict";
//See: https://octonion.institute/susy-go/wiki/SRLP
Object.defineProperty(exports, "__esModule", { value: true });
var bytes_1 = require("./bytes");
...
},{"./address":61,"./bignumber":62,"./bytes":63,"./errors":64,"./keccak256":68,"./srlp":71,"./secp256k1":72}],76:[function(require,module,exports){
"use strict";
///
// Bytes
Object.defineProperty(exports, "__esModule", { value: true });
...
function formatSophy(wei, options) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        scrypt_js_1.default(passwordBytes, salt, N, r, p, 64, function (error, progress, key) {
            if (error) {
                ...
                // See: https://octonion.institute/susy-go/wiki/SusyWeb-Secret-Storage-Definition
                var data = {
...
var words = "";
var wordlist = null;
